...
<html>
    ...
    ?>
        ...
        <div id="upperLeftSection">
            ...
            <form action="cart2.php?action=add&Item_ID=<?php echo $_GET['item_id'];?>" method="post">

            <!--- NOTE: THe following line might be necessaryu for passing hte item id to the new cart. --->
